//! Inspect the lamport balance and RPC context of a public Solana account.
...
mod component {
    ...
    const PLUGIN_NAME: &str = "account-balance";
    ...
    impl Tool for Plugin {
        ...
        fn description() -> String {
            "Inspect the lamport balance and RPC context of a public Solana account. Read-only: cannot sign, fund, approve, or submit transactions.".to_string()
        }
    ...
    fn emit(action: PluginAction, outcome: PluginOutcome, message: &str) {
        log_record(
            LogLevel::Info,
            &PluginEvent {
                function_name: "account_balance::tool::execute".to_string(),
                action,
