//! Read the ten latest confirmed signatures involving a public Solana address.
...
mod component {
    ...
    const PLUGIN_NAME: &str = "address-activity";
    ...
    impl Tool for Plugin {
        ...
        fn description() -> String {
            "Read the ten latest confirmed signatures involving a public Solana address. Read-only: cannot sign, fund, approve, or submit transactions.".to_string()
        }
    ...
    fn emit(action: PluginAction, outcome: PluginOutcome, message: &str) {
        log_record(
            LogLevel::Info,
            &PluginEvent {
                function_name: "address_activity::tool::execute".to_string(),
                action,
