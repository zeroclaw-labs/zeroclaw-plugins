...
//! (`payment-watch`). The component exports a tool name the model calls
//! (`payment_watch`). The host resolves config by package id and dispatches calls by
...
const PACKAGE_ID: &str = "payment-watch";
const EXPORTED_TOOL: &str = "payment_watch";
