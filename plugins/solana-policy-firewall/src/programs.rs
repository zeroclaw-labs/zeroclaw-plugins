...
use crate::transaction::{ParsedInstruction, ParsedTransaction};
...
fn analyze_instruction(
    ...
    match instruction.program_id.as_str() {
        SYSTEM_PROGRAM => analyze_system(instruction),
...
fn analyze_system(instruction: &ParsedInstruction) -> Result<Operation, String> {
    ...
    let code = match tag {
        ...
        4 | 5 | 6 | 7 | 12 => "nonce_authority_operation",
