//! A ZeroClaw WIT tool plugin: `solana_tx_inspect`.
//!
//! Inspect one Solana transaction by signature: slot, time, status, fee -
//! shaped for the model. Read-only (custody tier T0): the tool cannot sign, move funds, or
    ...
    impl Tool for Plugin {
        ...
        fn execute(args: String) -> Result<ToolResult, String> {
            ...
            log_record(
                LogLevel::Info,
                &PluginEvent {
                    function_name: "solana_tx_inspect::tool::execute".into(),
                    ...
                    duration_ms: None,
                    attrs: None,
                    message: "transaction inspection".into(),
                },
            );
