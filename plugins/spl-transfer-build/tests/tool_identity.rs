...
//! (`spl-transfer-build`). The component exports a tool name the model calls
//! (`spl_transfer_build`). The host resolves config by package id and dispatches calls by
...
const PACKAGE_ID: &str = "spl-transfer-build";
const EXPORTED_TOOL: &str = "spl_transfer_build";
