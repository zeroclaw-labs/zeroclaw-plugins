//! Inspect the current amount and decimals of a public SPL token mint.
...
mod component {
    ...
    const PLUGIN_NAME: &str = "token-supply";
    ...
    impl Tool for Plugin {
        ...
        fn description() -> String {
            "Inspect the current amount and decimals of a public SPL token mint. Read-only: cannot sign, fund, approve, or submit transactions.".to_string()
        }
    ...
    fn emit(action: PluginAction, outcome: PluginOutcome, message: &str) {
        log_record(
            LogLevel::Info,
            &PluginEvent {
                function_name: "token_supply::tool::execute".to_string(),
                action,
